      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="md:hidden bg-yaku-white border-t border-yaku-beige/50 overflow-hidden"
          >
            <div className="px-4 py-4 flex flex-col gap-3">
              {[
                ...
                <a
                  ...
                  className="text-yaku-chocolate hover:text-yaku-green font-medium py-2 px-3 rounded-lg hover:bg-yaku-cream transition-all"
                >
                  {link.label}
                </a>
              ))}
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-yaku-green text-white px-5 py-3 rounded-full font-medium text-center mt-2 flex items-center justify-center gap-2"
              >
