...
import Image from 'next/image'; // Preparado para imágenes locales
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {equipo.map((miembro, index) => (
            ...
            >
              <div className="w-32 h-32 bg-slate-200 rounded-full mb-4 overflow-hidden border-4 border-white shadow-lg group-hover:border-green-400 group-hover:scale-105 transition-all duration-300 relative">
                {/* Aquí se puede insertar la foto de los miembros cuando se suban
                    <Image src={`/equipo-${index + 1}.jpg`} alt={miembro.nombre} layout="fill" objectFit="cover" /> 
                */}
