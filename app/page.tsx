...
export default function Home() {
  ...
  const equipo = [
    ...
    /* TODO: AGREGAR MÁS ESTUDIANTES AQUÍ SI HACE FALTA
      Copia y pega la línea de arriba y cambia los datos. Ejemplo:
      { nombre: "Nuevo Estudiante", rol: "Investigación y Desarrollo", instagram: "https://instagram.com/" },
    */
  ];
    ...
    <main className="min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <header className="w-full bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-slate-200 rounded-full flex items-center justify-center border-2 border-green-500 overflow-hidden">
          ...
          <nav className="hidden md:flex gap-6">
            <a href="#acerca-de" className="text-slate-600 hover:text-green-600 transition-colors font-medium">Acerca de Inti</a>
            <a href="#beneficios" className="text-slate-600 hover:text-green-600 transition-colors font-medium">Beneficios</a>
            <a href="#informe" className="text-slate-600 hover:text-green-600 transition-colors font-medium">Investigación</a>
            <a href="#equipo" className="text-slate-600 hover:text-green-600 transition-colors font-medium">Equipo</a>
          </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-full font-bold text-lg transition-colors shadow-lg flex items-center justify-center gap-2">
                Comprar ahora
              </a>
              <a href="#beneficios" className="bg-slate-100 hover:bg-slate-200 text-slate-700 px-8 py-4 rounded-full font-bold text-lg transition-colors flex items-center justify-center gap-2">
                Ver Beneficios
              </a>
            </div>
          </div>
          <div className="w-full lg:w-1/2 relative">
            <div className="aspect-square bg-gradient-to-tr from-green-100 to-amber-50 rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] -z-10 blur-3xl opacity-60"></div>
            <div className="w-full aspect-square bg-slate-100 rounded-3xl shadow-xl flex items-center justify-center overflow-hidden border-8 border-white relative">
      ...
      <section id="acerca-de" className="w-full bg-slate-50 py-20 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm text-left border border-slate-100">
      ...
      <section id="beneficios" className="w-full bg-white py-20 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-green-50 p-8 rounded-3xl border border-green-100 hover:shadow-md transition-shadow">
            ...
            <div className="bg-amber-50 p-8 rounded-3xl border border-amber-100 hover:shadow-md transition-shadow">
            ...
            <div className="bg-blue-50 p-8 rounded-3xl border border-blue-100 hover:shadow-md transition-shadow">
      ...
      <section id="informe" className="w-full bg-slate-900 text-white py-20 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-slate-800 p-8 rounded-3xl border border-slate-700 shadow-2xl">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm text-slate-300">
                <div className="flex justify-between border-b border-slate-700 pb-1"><span>Energía</span> <span className="font-bold text-white">54 kcal</span></div>
                <div className="flex justify-between border-b border-slate-700 pb-1"><span>Agua</span> <span className="font-bold text-white">86 g</span></div>
                <div className="flex justify-between border-b border-slate-700 pb-1"><span>Proteína</span> <span className="font-bold text-white">0.3 g</span></div>
                <div className="flex justify-between border-b border-slate-700 pb-1"><span>Grasa total</span> <span className="font-bold text-white">0.03 g</span></div>
                <div className="flex justify-between border-b border-slate-700 pb-1"><span>Carbohidratos</span> <span className="font-bold text-white">12.5 g</span></div>
                <div className="flex justify-between border-b border-slate-700 pb-1"><span>Fibra</span> <span className="font-bold text-white">0.5 g</span></div>
                <div className="flex justify-between border-b border-slate-700 pb-1"><span>Calcio</span> <span className="font-bold text-white">23 mg</span></div>
                <div className="flex justify-between border-b border-slate-700 pb-1"><span>Fósforo</span> <span className="font-bold text-white">21 mg</span></div>
                <div className="flex justify-between border-b border-slate-700 pb-1"><span>Vitamina C</span> <span className="font-bold text-white">13.1 mg</span></div>
                <div className="flex justify-between border-b border-slate-700 pb-1"><span>Hierro</span> <span className="font-bold text-white">0.3 mg</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="equipo" className="w-full bg-slate-50 py-20 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* Mapeo dinámico del arreglo de estudiantes */}
            {equipo.map((miembro, index) => (
              <div key={index} className="flex flex-col items-center group">
                <div className="w-32 h-32 bg-slate-200 rounded-full mb-4 overflow-hidden border-4 border-white shadow-lg group-hover:border-green-100 transition-colors">
                  <svg className="w-full h-full text-slate-400 p-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
                  </svg>
                </div>
                <h3 className="font-bold text-lg text-slate-800 text-center">{miembro.nombre}</h3>
                <p className="text-sm text-green-600 mb-3 font-medium text-center">{miembro.rol}</p>
                <a href={miembro.instagram} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-pink-600 transition-colors flex items-center gap-1">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
